...
btn1 = Button(win, width=9, height=3, text="AC", fg="Green", bg="#313131", font=("Times New Roman", 12))
btn1.place(x=4, y=54)
btn2 = Button(win, width=9, height=3, text="⌫ ", fg="Green", bg="#313131", font=("Times New Roman", 12))
btn2.place(x=95, y=54)
btn3 = Button(win, width=9, height=3, text="+/_", fg="Green", bg="#313131", font=("Times New Roman", 12))
btn3.place(x=186, y=54)
btn4 = Button(win, width=9, height=3, text="+", fg="Green", bg="#313131", font=("Times New Roman", 12))
...
btn8 = Button(win, width=9, height=3, text="-", fg="Green", bg="#313131", font=("Times New Roman", 12))
...
btn12 = Button(win, width=9, height=3, text="x", fg="Green", bg="#313131", font=("Times New Roman", 12))
...
btn16 = Button(win, width=9, height=3, text="/", fg="Green", bg="#313131", font=("Times New Roman", 12))
...
btn18 = Button(win, width=9, height=3, text="=", fg="White", bg="Green", font=("Times New Roman", 12))
